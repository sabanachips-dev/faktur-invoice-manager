...
export default function BatchPrintDialog({ documents, disabled = false }: { documents: InvoiceDocumentData[]; disabled?: boolean }) {
  ...
  const fullPageCount = printPages.filter(page => page.mode === "full").length;
