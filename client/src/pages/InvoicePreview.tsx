...
import { Copy, Download, History, Mail, Pencil, Printer, Search, Share2, Truck } from "lucide-react";
...
export default function InvoicePreview() {
  ...
  const printQuickly = () => {
    printInvoice("a4");
    toast.success("Dialog cetak dibuka. Pilih printer atau Simpan sebagai PDF.");
  };
