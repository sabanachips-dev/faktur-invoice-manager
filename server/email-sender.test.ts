...
describe("email sender configuration", () => {
  ...
  it("submits the configured sender and client recipient to the email provider", async () => {
    ...
    await sendInvoiceEmail({
      ...
      invoice: {
        invoice: { id: 1, invoiceNumber: "INV-2026-001", invoiceDate: new Date("2026-08-20"), dueDate: new Date("2026-09-03"), status: "sent", currency: "IDR", subtotal: 100000, discount: 0, discountType: "amount", discountValue: 0, taxRate: 11, taxAmount: 11000, total: 111000, notes: null, storeNumber: null, shippingAddress: null, publicId: "public123" },
